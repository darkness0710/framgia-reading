<div id="modal-edit-book" class="modal fade login-box-wrapper max-height-500" tabindex="-1"
    ...
    <input type="hidden" name="" value="" id="edit_book_id">
        ...
        <div class="row height-320">
            <div class="modal-border">
                    ...
                    <div class="form-group pl-20">
                        ...
                        <div class="col-md-8">
                            <img id="cover_updated" class="image sm-avatar height-170" accept="image"
                                src="{{ asset('images/5.png') }}"/>
                            {{ Form::file('cover', [
                                'class' => 'mt-20',
                                'id' => 'upload_cover_edit',
                            ]) }}
    ...
    <div class="modal-footer height-70">
        <div class="row pull-right lt-20 mr-20">
            <button type="button"
                class="btn btn-primary btn-sm" id="btn_update">
